...
export default function Login() {
    ...
    return (
        <div className="min-h-screen flex bg-zinc-50 overflow-hidden font-sans">
            {/* Left Panel - Visuals */}
            <div className="hidden lg:flex lg:w-1/2 relative bg-zinc-900 overflow-hidden">
                <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1469854523086-cc02fe5d8800?q=80&w=2021&auto=format&fit=crop')] bg-cover bg-center opacity-50 mix-blend-overlay"></div>
                <div className="absolute inset-0 bg-gradient-to-br from-zinc-900 via-zinc-900/80 to-black/60"></div>
                ...
                <div className="relative z-10 flex flex-col justify-between p-16 h-full text-zinc-50">
                    <div>
                        ...
                        <h1 className="text-5xl font-light tracking-wide leading-tight mb-6">
                            Welcome to <br />
                            <span className="font-semibold text-white">GlobalTrotter</span>
                        </h1>
                        <p className="text-xl text-zinc-400 font-light max-w-md leading-relaxed">
                            Your personal AI travel companion. Discover, plan, and explore the world like never before.
                        </p>
                    </div>

                    <div className="space-y-4">
                        <div className="flex items-center space-x-4 text-zinc-400 text-sm font-light">
                            <span>© 2026 GlobalTrotter</span>
